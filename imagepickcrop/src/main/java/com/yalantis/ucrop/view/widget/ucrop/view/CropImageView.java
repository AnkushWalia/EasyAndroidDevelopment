package com.yalantis.ucrop.view.widget.ucrop.view;
...
import com.yalantis.ucrop.view.widget.ucrop.callback.CropBoundsChangeListener;
import com.yalantis.ucrop.view.widget.ucrop.model.CropParameters;
import com.yalantis.ucrop.view.widget.ucrop.model.ImageState;
import com.yalantis.ucrop.view.widget.ucrop.task.BitmapCropTask;
import com.yalantis.ucrop.view.widget.ucrop.util.CubicEasing;
import com.yalantis.ucrop.view.widget.ucrop.util.RectUtils;
...
public class CropImageView extends TransformImageView {
    ...
    public void cropAndSaveImage(@NonNull Bitmap.CompressFormat compressFormat, int compressQuality,
        ...
        new BitmapCropTask(getViewBitmap(), imageState, cropParameters, cropCallback, mContext).execute();
    }
