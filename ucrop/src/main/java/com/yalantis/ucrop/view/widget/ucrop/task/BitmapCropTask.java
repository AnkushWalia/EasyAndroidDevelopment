...
import com.yalantis.ucrop.view.widget.ucrop.util.FileUtils;
import com.yalantis.ucrop.view.widget.ucrop.util.ImageHeaderParser;
...
public class BitmapCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    public BitmapCropTask(@Nullable Bitmap viewBitmap, @NonNull ImageState imageState, @NonNull CropParameters cropParameters,
                          @Nullable BitmapCropCallback cropCallback, Context mContext) {
    ...
    protected void onPostExecute(@Nullable Throwable t) {
        if (mCropCallback != null) {
            if (t == null) {
                Uri uri = FileProvider.getUriForFile(mContext, mContext.getApplicationContext().getPackageName(), new File(mImageOutputPath));//Uri.fromFile(new File(mImageOutputPath));
